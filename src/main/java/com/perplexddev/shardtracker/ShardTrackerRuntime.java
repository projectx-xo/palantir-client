...
import com.perplexddev.shardtracker.color.ColorWheelScreen;
import com.perplexddev.shardtracker.config.PlayerListEditorScreen;
import com.perplexddev.shardtracker.config.Settings;
import com.perplexddev.shardtracker.hud.HudEditScreen;
import com.perplexddev.shardtracker.hud.ShardHudRenderer;
import com.perplexddev.shardtracker.keybind.ShardTrackerKeyBindings;
import com.perplexddev.shardtracker.notification.NotificationManager;
import com.perplexddev.shardtracker.notification.NotificationRenderer;
import com.perplexddev.shardtracker.notification.NotificationSound;
import com.perplexddev.shardtracker.notification.ShardNotification;
import com.perplexddev.shardtracker.tracker.ObservedPlayer;
import com.perplexddev.shardtracker.tracker.ShardScanner;
import com.perplexddev.shardtracker.tracker.ShardTracker;
import com.perplexddev.shardtracker.tracker.ShardUpdate;
 ...
 */
public final class ShardTrackerRuntime {
    ...
    private static ShardTrackerRuntime instance;
    ...
    /**
     * Runtime-only visibility toggle for {@link ShardTrackerKeyBindings#TOGGLE_HUD}. Deliberately
    ...
    private ShardTrackerRuntime(MinecraftClient client, Settings settings, Logger logger) {
        this.client = client;
    ...
    public static ShardTrackerRuntime create(MinecraftClient client, Settings settings, Logger logger) {
        ShardTrackerRuntime runtime = new ShardTrackerRuntime(client, settings, logger);
    ...
    public static ShardTrackerRuntime instance() {
        return instance;
    }
    ...
    private void handleKeyBindings() {
        while (ShardTrackerKeyBindings.TOGGLE_HUD.wasPressed()) {
            hudVisible = !hudVisible;
            announceVisibility();
        }
        while (ShardTrackerKeyBindings.OPEN_HUD_EDITOR.wasPressed()) {
    ...
    private void announceVisibility() {
        ...
        String message = hudVisible ? "Shard Tracker HUD shown" : "Shard Tracker HUD hidden";
