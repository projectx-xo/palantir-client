package com.perplexddev.shardtracker.config;

import com.perplexddev.shardtracker.color.AppearanceColorKey;
import com.perplexddev.shardtracker.hud.HudAnchor;
import com.perplexddev.shardtracker.hud.HudOptions;
import com.perplexddev.shardtracker.notification.NotificationOptions;
import com.perplexddev.shardtracker.tracker.TrackedPlayers;
import com.perplexddev.shardtracker.tracker.WildcardNameMatcher;
import com.perplexddev.shardtracker.tracker.TrackerOptions;
...
public final class Settings {
    ...
    private final me.shedaniel.autoconfig.ConfigHolder<ShardTrackerConfig> holder;
    ...
    private Settings(me.shedaniel.autoconfig.ConfigHolder<ShardTrackerConfig> holder) {
        this.holder = holder;
    }

    /** Registers the config with Cloth and derives the initial option set. */
    public static Settings register() {
        me.shedaniel.autoconfig.ConfigHolder<ShardTrackerConfig> holder =
                AutoConfig.register(ShardTrackerConfig.class, GsonConfigSerializer::new);
    ...
    public void saveHudPlacement(HudAnchor anchor, int offsetX, int offsetY, int scaleXPercent, int scaleYPercent) {
        ShardTrackerConfig config = holder.getConfig();
        config.hud.anchor = anchor;
        config.hud.offsetX = clamp(offsetX, ShardTrackerConfig.Bounds.MIN_OFFSET, ShardTrackerConfig.Bounds.MAX_OFFSET);
        config.hud.offsetY = clamp(offsetY, ShardTrackerConfig.Bounds.MIN_OFFSET, ShardTrackerConfig.Bounds.MAX_OFFSET);
        config.hud.scaleXPercent = clamp(scaleXPercent,
                ShardTrackerConfig.Bounds.MIN_SCALE_PERCENT, ShardTrackerConfig.Bounds.MAX_SCALE_PERCENT);
    ...
    public Map<AppearanceColorKey, Integer> appearanceColors() {
        ShardTrackerConfig.AppearanceSettings appearance = holder.getConfig().appearance;
