...
import com.perplexddev.shardtracker.notification.NotificationCorner;
 ...
 */
@Config(name = "shardtracker")
public class ShardTrackerConfig implements ConfigData {
    ...
    public static class TrackedPlayerSettings {
        ...
        /**
         * Edited only through {@link com.perplexddev.shardtracker.config.PlayerListEditorScreen},
